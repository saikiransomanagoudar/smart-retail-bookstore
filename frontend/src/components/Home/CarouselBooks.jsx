...
const Books = [
    { id: 'Art', label: 'Art', image: "https://source.unsplash.com/random/800x600/?art,cartoon"},
    { id: 'Biography', label: 'Biography', image: "https://source.unsplash.com/random/800x600/?biography,cartoon" },
  ...
  const CarouselBooks = () => {
    ...
    const handleGenreClick = (genre) => {
      ...
      navigate('/fav-authors', { state: { selectedGenre: genre } });
    };
      ...
      <div className="bg-zinc-900">
        <div className="mx-auto flex flex-col px-10 py-8 lg:py-0">
          ...
          <div className="relative w-full p-8">
            <Slider {...settings}>
              {Books.map((book) => (
                <div key={book.id} className="px-2" onClick={() => handleGenreClick(book.id)}>
